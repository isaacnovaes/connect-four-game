        ...
        >
            ...
            <g fill='none' fillRule='evenodd' id='Designs' stroke='none' strokeWidth='1'>
                <g id='counter-red-large'>
                    <circle cx='35' cy='35' fill='#000000' id='Oval-Copy-41' r='35' />
                    <circle cx='35' cy='40' fill='#000000' id='Oval-Copy-42' r='35' />
                    <g id='Oval-Copy-43'>
...
export default CounterRedLarge;
